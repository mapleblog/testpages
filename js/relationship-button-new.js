document.addEventListener('DOMContentLoaded', function() {
    ...
    if (confirmationButton) {
        let attempts = 0;
        const maxAttempts = 3; // 减少尝试次数，使体验更简约
    ...
    function showRelationshipConfirmed() {
        if (confirmationButton) {
            ...
            confirmationButton.style.background = 'rgba(253, 121, 168, 0.2)';
            confirmationButton.style.borderColor = 'var(--accent-color)';
            confirmationButton.style.color = 'var(--accent-color)';
