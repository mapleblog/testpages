/**
 * lovecat canvas - 抱着爱心的小猫绘制代码
 */
document.addEventListener('DOMContentLoaded', function() {
    // 获取canvas元素
    var canvas = document.getElementById('lovecatCanvas');
    if (!canvas || !canvas.getContext("2d")) return;
    
    var c = canvas.getContext("2d");
    
    // 绘制小猫和爱心
    function drawLoveCat() {
        // 清空画布
        ...
        c.quadraticCurveTo(252, 474, 237, 470);
        c.quadraticCurveTo(150, 424, 109, 372);
        c.closePath();
        c.fill();
    }
